...
interface Analytics {
    ...
    object Event {
        ...
        val OPEN_PALETTE_EXPORT_FILE = "OPEN_PALETTE_EXPORT_FILE"
        val OPEN_PALETTE_EXPORT_IMAGE = "OPEN_PALETTE_EXPORT_IMAGE"

        val CREATE_PALETTE = "CREATE_PALETTE"
        val OPEN_IN_APP_REVIEW = "OPEN_IN_APP_REVIEW"
        val DONE_IN_APP_REVIEW = "DONE_IN_APP_REVIEW"

        val CREATE_COLOR_CAMERA = "CREATE_COLOR_FROM_CAMERA"
        val CREATE_COLOR_IMAGE = "CREATE_COLOR_FROM_IMAGE"
        val CREATE_COLOR_DOMAIN_COLORS = "CREATE_COLOR_DOMAIN_COLORS"
        val CREATE_COLOR_WHEEL = "CREATE_COLOR_WHEEL"
