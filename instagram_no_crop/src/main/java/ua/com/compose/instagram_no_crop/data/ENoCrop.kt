...
enum class ENoCrop(val titleResId: Int, val iconResId: Int, val ratio: Ratio) {
    ...
    ONE_TO_ONE(titleResId= R.string.module_instagram_no_crop_fragment_crop_aspect_ratio_1_1, iconResId = R.drawable.module_instagram_no_crop_ic_crop_1_1, ratio = Ratio.AspectRatio(1f, 1f)),
