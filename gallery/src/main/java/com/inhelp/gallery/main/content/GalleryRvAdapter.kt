...
class GalleryRvAdapter(val images: MutableList<Uri>, val selectedImage: MutableList<Uri>, val onPress: (value: Uri, isLongPress: Boolean) -> Unit, val onUpdateBadge: () -> Unit) : RecyclerView.Adapter<GalleryRvAdapter.ViewHolder>() {
